  ...
  return (
    <div className="flex min-h-dvh flex-col px-5 pb-8 pt-[max(1.5rem,env(safe-area-inset-top))]">
      ...
      <textarea
        ...
        className="mt-5 w-full rounded-2xl border border-white/10 bg-white/5 p-4 text-[17px] text-mist outline-none placeholder:text-slate-500 focus:border-teal-500"
      />
      <p className="mt-1.5 text-right text-sm text-slate-500">{text.length}/120</p>
